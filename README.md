...
The installer requires Node.js 20 or newer, npm, and git when installing from the curl command. It builds the CLI and verifies that `agent-handoff --help` works.
